...
class MyMenu:
    ...
    def _options(self):
        ...
        root.iconbitmap("resources/icons/sett_ico.ico")
        root.title("Options")
    ...
    def _rewrite_theme_cfg(state):
        ...
        hover_clr = ""
        if state == "Dark":
            text_clr = tcfg._DARK_TEXT_COLOR
            main_clr = tcfg._DARK_MAIN_COLOR
            hover_clr = tcfg._DARK_HOVER_COLOR
        elif state == "Light":
            text_clr = tcfg._LIGHT_TEXT_COLOR
            main_clr = tcfg._LIGHT_MAIN_COLOR
            hover_clr = tcfg._LIGHT_HOVER_COLOR
        ...
        with open("resources/theme_cfg.py", "wt", encoding="utf-8") as file:
            file.write(new)
    ...
    def _help(self):
        ...
        root.geometry(f"{ww}x{wh}")
        root.attributes("-topmost", True)
        root.iconbitmap("resources/icons/i.ico")
        root.title("About..")
        info_text = """
