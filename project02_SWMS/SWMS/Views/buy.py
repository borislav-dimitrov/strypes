...
class Purchases:
    def __init__(self, m_screen, page_name, title, width, height, grid_rows, grid_cols):
        ...
        self.available_lb, self.available_items = TkServ.create_listbox(self.m_screen, "available_lb", row=10, column=0, width=35, height=25,
            rowspan=14, columnspan=1, data=[], padx=(10, 25), sticky="e")
        ...
        self.selected_supplier = TkServ.create_drop_down(self.m_screen, self.selected_supplier_var, self.drop_down_options, lambda a: PurControl.on_supplier_change(self.m_screen, self.selected_supplier_var),
            10, 3, stick="we")
        ...
        self.buy_btn = tk.Button(self.m_screen, text="Buy", width=25, name="buy_cart_btn", font=("Arial", 12), bg="coral",
    ...
    def add_to_cart(self):
        PurControl.add_item_to_cart(self.m_screen, self.cart_lb, self.available_lb, self.cart_items, self.multiplier_entry.get())

    def rem_from_cart(self):
        PurControl.rem_item_from_cart(self.m_screen, self.cart_lb, self.cart_items, self.multiplier_entry.get())
