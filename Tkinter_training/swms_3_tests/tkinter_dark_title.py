...
root.geometry('500x500+200+200')  # set new geometry the + 75 + 75 is where it starts on the screen
...
COLOR1 = '#3e4042'  # button color effects in the title bar (Hex color)     LIGHT GRAY
COLOR2 = '#25292e'  # window background color               (Hex color)     DARK GRAY
COLOR3 = '#10121f'  # title bar color                       (Hex color)     REGULAR GRAY

root.config(bg=COLOR2)
title_bar = Frame(root, bg=COLOR3, relief='raised', bd=0, highlightthickness=0)
...
close_button = Button(title_bar, text='  ×  ', command=root.destroy, bg=COLOR3, padx=2, pady=2, font=("calibri", 13),
                      bd=0, fg='white', highlightthickness=0)
expand_button = Button(title_bar, text=' 🗖 ', command=maximize_me, bg=COLOR3, padx=2, pady=2, bd=0, fg='white',
                       font=("calibri", 13), highlightthickness=0)
minimize_button = Button(title_bar, text=' 🗕 ', command=minimize_me, bg=COLOR3, padx=2, pady=2, bd=0, fg='white',
                         font=("calibri", 13), highlightthickness=0)
title_bar_title = Label(title_bar, text=tk_title, bg=COLOR3, bd=0, fg='white', font=("helvetica", 10),
                        highlightthickness=0)

# a frame for the main area of the window, this is where the actual app will go
window = Frame(root, bg=COLOR2, highlightthickness=0)
...
def returnx_to_normalstate(event):
    global close_button
    close_button['bg'] = COLOR3


def change_size_on_hovering(event):
    global expand_button
    expand_button['bg'] = COLOR1


def return_size_on_hovering(event):
    global expand_button
    expand_button['bg'] = COLOR3


def changem_size_on_hovering(event):
    global minimize_button
    minimize_button['bg'] = COLOR1


def returnm_size_on_hovering(event):
    global minimize_button
    minimize_button['bg'] = COLOR3
...
resizex_widget = Frame(window, bg=COLOR2, cursor='sb_h_double_arrow')
...
def resizex(event):
    ...
    resizex_widget.config(bg=COLOR2)
...
resizey_widget = Frame(window, bg=COLOR2, cursor='sb_v_double_arrow')
