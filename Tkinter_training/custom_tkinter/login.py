...
class MyCtkLogin:
    def __init__(self, m_screen, page_name, title, resolution: tuple, grid_rows=30, grid_cols=30):
        ...
        # Create GUI
        # Create Header
        self.header = ctk.CTkLabel(self.m_screen, text=self.page_name, text_font=self.heading, text_color=BLUE)
        self.header.grid(row=0, column=1, columnspan=self.cols-2, sticky="we")

        # Create Labels
        self.uname_lbl = ctk.CTkLabel(self.m_screen, text="Username:", text_font=self.text_bold, text_color=BLUE)
        self.uname_lbl.grid(row=2, column=1, columnspan=2, sticky="we")
        self.pwd_lbl = ctk.CTkLabel(self.m_screen, text="Password:", text_font=self.text_bold, text_color=BLUE)
